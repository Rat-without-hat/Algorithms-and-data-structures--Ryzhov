...
### [Решение](bubble_sort_C_D/task_D/D.cpp)
...
### [Решение](quick_sort_F/F.py)

## Задача №111166. Сортировка подсчетом

Дан список из 𝑁 (𝑁 ≤ 2*10^5) элементов, которые принимают целые значения от 0 до 100.
...
### [Решение](anti_quick_sort_K/K.py)
...
В первой строке записаны 𝑁 чисел через пробел, задающих расстояния в километрах от работы до домов сотрудников компании. Во второй строке записаны 𝑁 чисел — тарифы за проезд одного километра в такси.
